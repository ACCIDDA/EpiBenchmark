...
Once completing the installation instructions, you will have all EpiBenchmark commands available to you (see: `epibench --help`). The EpiBenchmark package has 3 primary functionalities, each with its own `epibench` sub-command:
