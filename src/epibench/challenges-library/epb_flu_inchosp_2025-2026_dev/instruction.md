# EpiBenchmark challenge: `epb_flu_inchosp_2025-2026_dev_70a64b89c2`
...
The challenge is derived from the 2025–2026 [FluSight Forecast Hub](https://github.com/cdcepi/FluSight-forecast-hub). It evaluates forecasts of weekly incident influenza hospital admissions, using the target name `wk inc flu hosp`.

## Challenge details

| Field | Value |
| --- | --- |
| Challenge ID | `epb_flu_inchosp_2025-2026_dev_70a64b89c2` |
| Challenge name | `epb_flu_inchosp_2025-2026_dev` |
| Source hub | [FluSight Forecast Hub](https://github.com/cdcepi/FluSight-forecast-hub), 2025–2026 season |
| Pathogen | Influenza |
...
```text
2025-11-22,wk inc flu hosp,0,2025-11-22,01,quantile,0.05,10
```
...
```bash
epibench score epb_flu_inchosp_2025-2026_dev \
  --model-data-path "challenges/epb_flu_inchosp_2025-2026_dev_70a64b89c2/model-output/<model_name>.csv" \
  --model-name "<model_name>" \
  --output-path "results/epb_flu_inchosp_2025-2026_dev/<model_name>"
```
...
**Report your scorecard.** The deliverable for this challenge is the `EpiBenchmark_scorecard.csv` produced by `epibench score epb_flu_inchosp_2025-2026_dev` — it is the official record of your model's performance and is what should be submitted or reported.
