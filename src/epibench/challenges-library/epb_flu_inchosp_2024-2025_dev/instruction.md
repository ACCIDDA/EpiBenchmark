...
The challenge is derived from the 2024–2025 [FluSight Forecast Hub](https://github.com/cdcepi/FluSight-forecast-hub). It evaluates forecasts of weekly incident influenza hospital admissions, using the target name `wk inc flu hosp`.
...
| Frequency | Weekly |
| Reference-date span | 2024-11-23 to 2025-05-31 |
| Forecast-date span | 2024-11-23 to 2025-06-21 |
| Locations | 52 jurisdictions, including `US` |
| Horizons | 0, 1, 2, and 3 |
| Required forecast tasks | 5,616 (27 reference dates × 52 locations × 4 horizons) |
